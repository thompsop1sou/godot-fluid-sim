...
Vec3::Vec3(const Vec3& other_vec3) : x(other_vec3.x), y(other_vec3.y), z(other_vec3.z)
{}

Vec3::Vec3(float p_xyz) : x(p_xyz), y(p_xyz), z(p_xyz)
{}

Vec3::Vec3(float p_x, float p_y, float p_z) : x(p_x), y(p_y), z(p_z)
{}

Vec3::Vec3(godot::Vector3 &godot_vector3) : x(godot_vector3.x), y(godot_vector3.y), z(godot_vector3.z)
{}
...
// Overloaded Left/Right Operators
